...
Table of Contents
Task	Title
1	Reading Exercise - Begin your Journey in IT
2	Reading Exercise - Understand What is a Local Repository
3	Reading Exercise - What is a Remote Repository
4	Reading Exercise - GIT Architecture
5	Operational Excellence using GIT
...
Questions
Are you clear about what a Browser is now?
Are you clear about what a File Folder is on your Windows Laptop?
...
What is the purpose of the hidden .git folder?
What is the difference between commit and push?
Why can Git work without internet access?
Task 5 - Operational Excellence using GIT


Reflection Questions
Why is Git important for developers?
Why is GitHub useful for teamwork?
Why should developers use version control?
What happens if code is not backed up properly?
Why is collaboration important in IT?
Final Activity
